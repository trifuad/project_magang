...
class listpegawai extends AUTH_Controller {
	...
	public function index() {
		...
		$data['page'] = "listpegawai";
		$data['judul'] = "List Data Pegawai";
		$data['deskripsi'] = "Manage Data Pegawai";

		$data['modal_tambah_pegawai'] = show_my_modal('modals/modal_tambah_pegawai', 'tambah-pegawai', $data);

		$this->template->views('listpegawai/listpegawai', $data);
		
	}

	public function tampil() {
		$data['dataPegawai'] = $this->M_pegawai->select_all();
		$this->load->view('listpegawai/list_data', $data);
	}
