...
<div class="box">
  <div class="box-header">
    ...
    <div class="col-md-3">
        <a href="<?php echo base_url('listpegawai/export'); ?>" class="form-control btn btn-default"><i class="glyphicon glyphicon glyphicon-floppy-save"></i> Export Data Excel</a>
    </div>
    <div class="col-md-3">
